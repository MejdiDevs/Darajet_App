...
إجابة اللاعب ب: ${answerB}`;
    ...
    try {
        ...
        return {
            ...
            score_a: null,
            score_b: null,
            correction_a_ar: 'حدث خطأ أثناء التقييم. يرجى المحاولة مرة أخرى.',
            correction_b_ar: 'حدث خطأ أثناء التقييم. يرجى المحاولة مرة أخرى.',
...
سلسلة الأيام: ${streakDays}`;
    ...
    try {
        ...
        return {
            score: null,
            correction_ar: 'حدث خطأ أثناء التقييم. يرجى المحاولة مرة أخرى.',
